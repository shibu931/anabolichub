...
const ReviewCard = ({ productSlug = null, review }) => {
    ...
    return (
        <div className='border bg-white shadow p-2 pb-7 border-gray-400 relative'>
            <div className='px-2 flex justify-between items-center'>
                <div>
                    ...
                    {productSlug && (<span className='text-xs font-semibold text-gray-600 block'>Produkt: <Link className='underline' href={productSlug}>{productSlug.replaceAll("-", " ").toUpperCase()}</Link></span>)}
                </div>
